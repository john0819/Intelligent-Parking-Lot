...
QT_MOC_LITERAL(1, 9, 11), // "Send2Widget"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 3), // "Mat"
QT_MOC_LITERAL(4, 26, 5), // "frame"
QT_MOC_LITERAL(5, 32, 10) // "Sendchange"

    },
    "MyThread\0Send2Widget\0\0Mat\0frame\0"
    "Sendchange"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Send2Widget((*reinterpret_cast< Mat(*)>(_a[1]))); break;
        case 1: _t->Sendchange(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (MyThread::*_t)(Mat );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::Send2Widget)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::Sendchange)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::Send2Widget(Mat _t1)
{
